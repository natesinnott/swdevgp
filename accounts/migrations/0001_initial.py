...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Team',
            fields=[
                ('team', models.AutoField(db_column='teamID', primary_key=True, serialize=False)),
                ('teamName', models.CharField(db_column='teamName', max_length=100)),
                ('teamLeaderID', models.IntegerField(db_column='teamLeaderID')),
                ('department', models.ForeignKey(db_column='departmentID', default=0, on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.department')),
            ],
            options={
                'db_table': 'Team',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(blank=True, db_column='teamID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.team')),
            ],
            options={
                'db_table': 'Employee',
            },
        ...
        migrations.AddField(
            ...
            name='team',
            field=models.ForeignKey(blank=True, db_column='teamID', null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.team'),
        ),
    ]
